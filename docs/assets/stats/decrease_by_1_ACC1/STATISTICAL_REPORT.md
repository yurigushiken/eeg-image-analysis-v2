...
|-----------|---|------|----|----|-------|
| 2 to 1 | 7 | 105.14 ms | 9.44 | 3.57 | [96.00, 116.00] |
| 3 to 2 | 10 | 107.20 ms | 8.60 | 2.72 | [96.00, 116.00] |
| 4 to 3 | 13 | 105.23 ms | 9.29 | 2.58 | [96.00, 116.00] |
| 5 to 4 | 7 | 106.29 ms | 9.48 | 3.58 | [96.00, 116.00] |
| 6 to 5 | 8 | 104.50 ms | 9.43 | 3.33 | [96.00, 116.00] |

#### Amplitude (Peak)

| Condition | N | Mean | SD | SEM | Range |
|-----------|---|------|----|----|-------|
| 2 to 1 | 7 | 3.44 µV | 2.35 | 0.89 | [0.31, 6.52] |
| 3 to 2 | 10 | 2.64 µV | 1.19 | 0.38 | [1.11, 4.23] |
| 4 to 3 | 13 | 2.35 µV | 0.89 | 0.25 | [1.08, 3.82] |
| 5 to 4 | 7 | 3.46 µV | 1.12 | 0.42 | [1.78, 5.14] |
| 6 to 5 | 8 | 5.09 µV | 1.72 | 0.61 | [2.42, 7.38] |
...
- AIC = 337.97, BIC = 352.43
- **3 to 2 vs 2 to 1**: *β* = 1.98, *SE* = 4.289, *z* = 0.462, *p* = 0.644
- **4 to 3 vs 2 to 1**: *β* = -0.33, *SE* = 4.132, *z* = -0.080, *p* = 0.936
- **5 to 4 vs 2 to 1**: *β* = 0.94, *SE* = 4.771, *z* = 0.198, *p* = 0.843
- **6 to 5 vs 2 to 1**: *β* = -0.81, *SE* = 4.491, *z* = -0.181, *p* = 0.857
- **SNR**: *β* = -0.66, *SE* = 1.331, *z* = -0.496, *p* = 0.620
...
|------------|---|----|----|-----------|---------|-----|
| 2 to 1 - 3 to 2 | -1.98 | 4.29 | -0.46 | 0.644 | 1.000 | n.s. |
| 2 to 1 - 4 to 3 | 0.33 | 4.13 | 0.08 | 0.936 | 1.000 | n.s. |
| 2 to 1 - 5 to 4 | -0.94 | 4.77 | -0.20 | 0.843 | 1.000 | n.s. |
| 2 to 1 - 6 to 5 | 0.81 | 4.49 | 0.18 | 0.857 | 1.000 | n.s. |
| 3 to 2 - 4 to 3 | 2.31 | 3.75 | 0.62 | 0.537 | 0.999 | n.s. |
| 3 to 2 - 5 to 4 | 1.04 | 4.54 | 0.23 | 0.819 | 1.000 | n.s. |
| 3 to 2 - 6 to 5 | 2.79 | 4.13 | 0.68 | 0.499 | 0.999 | n.s. |
| 4 to 3 - 5 to 4 | -1.28 | 4.17 | -0.31 | 0.760 | 1.000 | n.s. |
| 4 to 3 - 6 to 5 | 0.48 | 3.92 | 0.12 | 0.903 | 1.000 | n.s. |
| 5 to 4 - 6 to 5 | 1.76 | 4.62 | 0.38 | 0.704 | 1.000 | n.s. |
...
- Model converged successfully
- AIC = 145.82, BIC = 160.27
- **3 to 2 vs 2 to 1**: *β* = -0.68, *SE* = 0.481, *z* = -1.409, *p* = 0.159
- **4 to 3 vs 2 to 1**: *β* = -0.66, *SE* = 0.464, *z* = -1.431, *p* = 0.152
- **5 to 4 vs 2 to 1**: *β* = 0.17, *SE* = 0.515, *z* = 0.324, *p* = 0.746
- **6 to 5 vs 2 to 1**: *β* = 1.80, *SE* = 0.503, *z* = 3.576, *p* < .001
- **SNR**: *β* = 0.78, *SE* = 0.138, *z* = 5.658, *p* < .001
...
| Comparison | β | SE | z | p (unadj) | p (adj) | Sig |
|------------|---|----|----|-----------|---------|-----|
| 2 to 1 - 3 to 2 | 0.68 | 0.48 | 1.41 | 0.159 | 0.484 | n.s. |
| 2 to 1 - 4 to 3 | 0.66 | 0.46 | 1.43 | 0.152 | 0.484 | n.s. |
| 2 to 1 - 5 to 4 | -0.17 | 0.52 | -0.32 | 0.746 | 0.935 | n.s. |
| 2 to 1 - 6 to 5 | -1.80 | 0.50 | -3.58 | < .001 | 0.003 | ** |
| 3 to 2 - 4 to 3 | -0.01 | 0.40 | -0.03 | 0.972 | 0.972 | n.s. |
| 3 to 2 - 5 to 4 | -0.85 | 0.48 | -1.76 | 0.078 | 0.354 | n.s. |
| 3 to 2 - 6 to 5 | -2.48 | 0.46 | -5.41 | < .001 | < .001 | *** |
| 4 to 3 - 5 to 4 | -0.83 | 0.46 | -1.81 | 0.070 | 0.354 | n.s. |
| 4 to 3 - 6 to 5 | -2.46 | 0.44 | -5.62 | < .001 | < .001 | *** |
| 5 to 4 - 6 to 5 | -1.63 | 0.51 | -3.22 | 0.001 | 0.009 | ** |

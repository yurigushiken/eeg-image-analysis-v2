...
|-----------|---|------|----|----|-------|
| 3a | 15 | 104.80 ms | 9.59 | 2.48 | [88.00, 116.00] |
| 3b | 6 | 106.67 ms | 9.35 | 3.82 | [96.00, 116.00] |
| 3c | 12 | 102.33 ms | 8.26 | 2.38 | [88.00, 116.00] |
| 3d | 7 | 100.00 ms | 10.58 | 4.00 | [88.00, 116.00] |
| 3e | 10 | 105.20 ms | 10.51 | 3.32 | [88.00, 116.00] |

#### Amplitude (Peak)

| Condition | N | Mean | SD | SEM | Range |
|-----------|---|------|----|----|-------|
| 3a | 15 | -4.27 µV | 2.79 | 0.72 | [-9.97, -1.63] |
| 3b | 6 | -7.06 µV | 3.99 | 1.63 | [-12.40, -2.54] |
| 3c | 12 | -5.53 µV | 2.08 | 0.60 | [-10.04, -2.09] |
| 3d | 7 | -5.84 µV | 2.02 | 0.76 | [-9.25, -3.54] |
| 3e | 10 | -5.37 µV | 2.70 | 0.85 | [-11.30, -2.07] |
...
- AIC = 378.11, BIC = 393.41
- **3b vs 3a**: *β* = 1.03, *SE* = 3.373, *z* = 0.306, *p* = 0.760
- **3c vs 3a**: *β* = -3.53, *SE* = 3.751, *z* = -0.940, *p* = 0.347
- **3d vs 3a**: *β* = -4.99, *SE* = 4.112, *z* = -1.212, *p* = 0.225
- **3e vs 3a**: *β* = 0.07, *SE* = 3.354, *z* = 0.020, *p* = 0.984
- **SNR**: *β* = 0.88, *SE* = 1.125, *z* = 0.780, *p* = 0.435
...
|------------|---|----|----|-----------|---------|-----|
| 3a - 3b | -1.03 | 3.37 | -0.31 | 0.760 | 0.996 | n.s. |
| 3a - 3c | 3.53 | 3.75 | 0.94 | 0.347 | 0.892 | n.s. |
| 3a - 3d | 4.99 | 4.11 | 1.21 | 0.225 | 0.833 | n.s. |
| 3a - 3e | -0.07 | 3.35 | -0.02 | 0.984 | 0.996 | n.s. |
| 3b - 3c | 4.56 | 3.21 | 1.42 | 0.156 | 0.782 | n.s. |
| 3b - 3d | 6.02 | 3.70 | 1.63 | 0.104 | 0.667 | n.s. |
| 3b - 3e | 0.96 | 4.51 | 0.21 | 0.831 | 0.996 | n.s. |
| 3c - 3d | 1.46 | 4.43 | 0.33 | 0.742 | 0.996 | n.s. |
| 3c - 3e | -3.59 | 3.54 | -1.01 | 0.310 | 0.892 | n.s. |
| 3d - 3e | -5.05 | 3.92 | -1.29 | 0.197 | 0.827 | n.s. |
...
- Model converged successfully
- AIC = 224.06, BIC = 239.35
- **3b vs 3a**: *β* = -1.26, *SE* = 0.966, *z* = -1.308, *p* = 0.191
- **3c vs 3a**: *β* = 0.63, *SE* = 0.808, *z* = 0.784, *p* = 0.433
- **3d vs 3a**: *β* = -1.30, *SE* = 0.867, *z* = -1.506, *p* = 0.132
- **3e vs 3a**: *β* = -0.55, *SE* = 0.771, *z* = -0.708, *p* = 0.479
- **SNR**: *β* = -1.50, *SE* = 0.247, *z* = -6.059, *p* < .001
...
| Comparison | β | SE | z | p (unadj) | p (adj) | Sig |
|------------|---|----|----|-----------|---------|-----|
| 3a - 3b | 1.26 | 0.97 | 1.31 | 0.191 | 0.721 | n.s. |
| 3a - 3c | -0.63 | 0.81 | -0.78 | 0.433 | 0.934 | n.s. |
| 3a - 3d | 1.31 | 0.87 | 1.51 | 0.132 | 0.678 | n.s. |
| 3a - 3e | 0.55 | 0.77 | 0.71 | 0.479 | 0.934 | n.s. |
| 3b - 3c | -1.90 | 0.95 | -1.99 | 0.046 | 0.379 | n.s. |
| 3b - 3d | 0.04 | 1.13 | 0.04 | 0.971 | 0.971 | n.s. |
| 3b - 3e | -0.72 | 1.01 | -0.71 | 0.475 | 0.934 | n.s. |
| 3c - 3d | 1.94 | 0.98 | 1.98 | 0.048 | 0.379 | n.s. |
| 3c - 3e | 1.18 | 0.85 | 1.38 | 0.167 | 0.721 | n.s. |
| 3d - 3e | -0.76 | 0.94 | -0.81 | 0.420 | 0.934 | n.s. |
